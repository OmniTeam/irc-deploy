...
class UrlMappings {
    ...
    static mappings = {
        ...
        get "/$controller/getWorkPlanRecord(.$format)?"(action:"getWorkPlanRecord")
        ...
        get "/$controller/getReportingCalendarByWorkPlanId(.$format)?"(action:"getReportingCalendarByWorkPlanId")
