...
class ProgramStaffControllerSpec extends Specification implements ControllerUnitTest<ProgramStaffController>, DomainUnitTest<ProgramStaff> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new ProgramStaff(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new ProgramStaff(params)
        instance.id = 1
        instance.version = 0
